                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <section className="space-y-2 *:leading-relaxed *:text-justify">
                            <p>
                                ...
                                PROEMEM, com intuito informar a sociedade e dar
                                mais transparência sobre as etapas do novo
                                ...
                                PROEMEM é viável ambiental e socialmente, desde
                                que sejam adotadas as medidas previstas no PGAS.
                                O projeto contribui para o desenvolvimento
                            ...
                            <p>
                                ...
                                execução do PROEMEM ocorra de forma planejada,
                                segura e compatível com os princípios da
                                sustentabilidade ambiental, da justiça social e
                            ...
                            <p>
                                ...
                                planejamento e execução do PROEMEM, programa
                            ...
                            <p>
                                ...
                                intervenções físicas previstas no PROEMEM sejam
                                desenvolvidas em conformidade com a legislação
                                ambiental brasileira, os regulamentos municipais
                                e os Padrões de Desempenho Ambiental e Social
                                (PDAS) definidos pelo Marco de Políticas
                                Ambientais e Sociais (MPAS) do BID.
                            </p>
                            <p>
                                O objetivo geral do PGAS é assegurar que as
                                obras e intervenções do PROEMEM sejam executadas
                                de maneira ambientalmente responsável e
                                socialmente sustentável, conforme a legislação
